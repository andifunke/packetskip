/*
AbstractAppMessage * Copyright (c) 2012-2013 Open Source Community - <http://www.peerfact.org>
 ...
 */
public class SearchResultACKMessage extends DefaultACKMessage
									implements SearchResultCategory {

	private static final long serialVersionUID = -2273691912978846127L;

	public SearchResultACKMessage(
	...
	public AbstractAppMessage copy() {
		return new SearchResultACKMessage(
