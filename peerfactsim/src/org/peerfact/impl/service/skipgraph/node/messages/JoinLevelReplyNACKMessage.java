 ...
 */
public class JoinLevelReplyNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public JoinLevelReplyNACKMessage(
	...
	/** 
	 * constructur to set the senderIsDisabled flag
	 * @param sender
	 * @param receiver
	 * @param operationID
	 * @param senderIsDisabled
	 */
	public JoinLevelReplyNACKMessage(
			ApplicationContact sender,
			ApplicationContact receiver,
	...
	public AbstractAppMessage copy() {
		return new JoinLevelReplyNACKMessage(
