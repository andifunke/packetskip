 ...
 */
public class RangeAdjustmentNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public RangeAdjustmentNACKMessage(
	...
	public AbstractAppMessage copy() {
		return new RangeAdjustmentNACKMessage(
