 ...
 */
public class RangeAdjustmentMessage extends AbstractSkipgraphNodeRequestMessage
	...
	public RangeAdjustmentMessage(ApplicationContact sender,
	...
	@Override
	public long getSize() {
		return super.getSize() + senderContact.getTransmissionSize();
	}
	
	
	@Override
	public String toString() {
		return super.toString() + " senderContact="+senderContact;
	}
