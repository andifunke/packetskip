 ...
 */
public class UpdateForwardingNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public UpdateForwardingNACKMessage(
	...
	public AbstractAppMessage copy() {
		return new UpdateForwardingNACKMessage(
