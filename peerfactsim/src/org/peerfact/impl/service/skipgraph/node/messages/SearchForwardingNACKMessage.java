 ...
 */
public class SearchForwardingNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public SearchForwardingNACKMessage(
	...
	public AbstractAppMessage copy() {
		return new SearchForwardingNACKMessage(
