 ...
 */
public class ReplaceContactsNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public ReplaceContactsNACKMessage(
	...
	public AbstractAppMessage copy() {
		return new ReplaceContactsNACKMessage(
