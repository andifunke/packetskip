 ...
 */
public class JoinLevelRequestNACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public JoinLevelRequestNACKMessage(
	...
	public AbstractAppMessage copy() {
		return new JoinLevelRequestNACKMessage(
