 ...
 */
public class UpdateForwardingACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public UpdateForwardingACKMessage(
	...
	public AbstractAppMessage copy() {
		return new UpdateForwardingACKMessage(
