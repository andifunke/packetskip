 ...
 */
public class SearchForwardingACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public SearchForwardingACKMessage(
	...
	public AbstractAppMessage copy() {
		return new SearchForwardingACKMessage(
