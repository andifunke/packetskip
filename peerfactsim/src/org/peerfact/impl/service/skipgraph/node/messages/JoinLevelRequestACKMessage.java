 ...
 */
public class JoinLevelRequestACKMessage extends AbstractSkipgraphNodeResponseMessage
	...
	public JoinLevelRequestACKMessage(
	...
	public AbstractAppMessage copy() {
		return new JoinLevelRequestACKMessage(
